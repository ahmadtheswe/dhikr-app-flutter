      ...
      body: Center(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const MenuTitle(text: Languages.COMMON_SELECT_LANGUAGE, icon: Icons.language),
              ...
              const MenuTitle(text: Languages.COMMON_SELECT_DARK_MODE, icon: Icons.dark_mode),
              Switch(
              ...
              const SizedBox(height: 40),
              const MenuTitle(text: Languages.COMMON_WAKE_UP_MODE, icon: Icons.lightbulb_circle),
              Switch(
